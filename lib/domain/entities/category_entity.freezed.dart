...
@override
String toString() {
  return 'CategoryEntity(id: $id, name: $name, iconURL: $iconURL, order: $order, productCount: $productCount)';
}
...
class _CategoryEntity implements CategoryEntity {
  const _CategoryEntity({required this.id, required this.name, this.iconURL = '', this.order = 0, this.productCount = 0});
