...
@override
String toString() {
  return 'ProductModel(id: $id, name: $name, brand: $brand, category: $category, description: $description, price: $price, discountPrice: $discountPrice, images: $images, specs: $specs, colors: $colors, stock: $stock, sold: $sold, rating: $rating, reviewCount: $reviewCount, tags: $tags, isActive: $isActive, isFeatured: $isFeatured, createdAt: $createdAt, updatedAt: $updatedAt)';
}
